...
func main() {
	...
	if *exportCloud && *output != "" {
		...
		fmt.Printf("[DEBUG] Disk Key : %X\n", diskKey)
		fmt.Printf("[DEBUG] Disk Key Digest : %X\n", digest256)
		fmt.Printf("[DEBUG] Encrypted Disk Key : %X\n", encryptedDiskKey)
		...
		fmt.Printf("[DEBUG] AttestVolumeKeyData : %X\n", encryptedVaultKey)
		fmt.Printf("[DEBUG] AttestVolumeKeyData (b64) : %s\n", base64.StdEncoding.EncodeToString(encryptedVaultKey))
		...
		fmt.Printf("[DEBUG] AttestVolumeKey : %X\n", volumeKey)
		fmt.Printf("[DEBUG] AttestVolumeKey (b64) : %s\n", base64.StdEncoding.EncodeToString(volumeKey))
